...
ActiveRecord::Schema.define(version: 20160326025100) do
  ...
  create_table "bank_banks", force: :cascade do |t|
    t.string "name"
    t.string "image_url"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "mandrill_email_settings", force: :cascade do |t|
    t.string "key"
  ...
  create_table "marriage_albums", force: :cascade do |t|
    t.integer "marriage_id"
  ...
  create_table "marriage_events", force: :cascade do |t|
    t.time "time"
    t.integer "marriage_id"
  ...
  create_table "marriage_gift_links", force: :cascade do |t|
    t.integer "gift_id"
  ...
  create_table "marriage_gifts", force: :cascade do |t|
    t.string "name"
    t.string "image_url"
    t.string "description"
    t.datetime "created_at"
  ...
  create_table "marriage_guests", force: :cascade do |t|
    t.integer "invite_id"
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "marriage_invites", force: :cascade do |t|
    t.integer "marriage_id"
    t.string "label"
    t.integer "invites"
    t.integer "expected"
  ...
  create_table "marriage_locations", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.text "map_url"
  ...
  create_table "marriage_marriages", force: :cascade do |t|
    t.date "date"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "marriage_pictures", force: :cascade do |t|
    t.integer "album_id"
    t.string "name", limit: 14
    t.string "url"
    t.string "snap_url"
  ...
  create_table "store_stores", force: :cascade do |t|
    t.string "name"
    t.string "image_url"
    t.string "url"
    t.datetime "created_at"
